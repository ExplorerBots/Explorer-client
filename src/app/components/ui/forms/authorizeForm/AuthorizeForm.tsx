   ...
   return <div className={styles.screen}>
      ...
      >
         ...
         <div className={styles.cont}>
            ...
            <p className={styles.answer}><Link href="/restore-password" className={styles.link}> Забыл пароль</Link></p>
            <p className={styles.answer}><Link href="/registration" className={styles.link}> Регистрация</Link></p>
            </div>
         </div>
      </motion.div >
   </div>
